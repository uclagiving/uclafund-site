		...
		<div class="container">
			<div class="row">
				...
				<div style="text-align:right" class="col-md-5 col-sm-5 text-right our-info">
					<span>
						<a style="padding:0" href="http://uclafund.ucla.edu/alumni" class="learn" title="alumni portal">Alumni</a> | 
						<a style="padding:0" href="http://uclafund.ucla.edu/students/" class="learn" title="student portal">Students</a> | 
						<a style="padding:0" href="http://uclafund.ucla.edu/parents/" class="learn" title="parents portal">Parents</a> | 
						<a style="padding:0" href="http://uclafund.ucla.edu/friends/" class="learn" title="friends portal">Friends</a> | 
						<a style="padding:0" href="http://uclafund.ucla.edu/my-account/" class="learn" title="my account portal">My Account</a>
					</span>
				</div>
