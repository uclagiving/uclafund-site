		...
		<td>
			<table>
				...
				<tr>
					...
					<td width="30" style="width: 30px;"></td>
					<td width="285" bgcolor="#f2f2f2" style="background-color: #f2f2f2; padding: 15px; width: 285px;" valign="top">
						<h4 style="font-size: 16px; font-weight: normal; margin: 0;"><?php _e( 'Get 40% Off!', 'wp-offload-ses' ); ?></h4>
						<p style="font-size: 13px;"><?php _e( 'We\'re celebrating the launch of WP Offload SES with 40% off! No coupon code necessary, simply purchase from our site and you\'ll receive 40% off for a limited time only.', 'wp-offload-ses' ); ?></p>
						<?php
						...
						?>
						<p><a href="<?php echo esc_url( $upgrade_url ); ?>" style="border: 2px solid #000000; padding: 10px; font-size: 16px; color: #000000; background: #ffffff; text-decoration: none;"><?php _e( 'Get Your 40% Off Now', 'wp-offload-ses' ); ?></a></p>
					</td>
				</tr>
			</table>
		</td>
