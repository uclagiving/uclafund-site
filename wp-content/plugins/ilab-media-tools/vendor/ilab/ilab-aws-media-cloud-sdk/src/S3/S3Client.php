...
class S3Client extends AwsClient implements S3ClientInterface
{
     ...
     * {@see ILABAmazon\AwsClient::__construct}, S3Client accepts the following
     * options:
     *
    ...
    public function createPresignedRequest(CommandInterface $command, $expires)
    {
        ...
        /** @var \ILABAmazon\Signature\SignatureInterface $signer */
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \ILABAmazon\serialize($command)->getUri();
    }
