<?php
namespace ILABAmazon\EndpointDiscovery;

use ILABAmazon\CacheInterface;
use ILABAmazon\EndpointDiscovery\Exception\ConfigurationException;
use GuzzleHttp\Promise;
use GuzzleHttp\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \ILABAmazon\EndpointDiscovery\ConfigurationInterface}
 * or rejected with an {@see \ILABAmazon\EndpointDiscovery\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see ILABAmazon\EndpointDiscovery\ConfigurationProvider::chain}. This function
...
class ConfigurationProvider
{
     ...
     * instance of ILABAmazon\CacheInterface. Forwards calls when no config found
