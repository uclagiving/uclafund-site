...
curl -LO "https://downloads.wordpress.org/plugin/all-in-one-wp-security-and-firewall.5.4.1.zip"
...
curl -LO "https://downloads.wordpress.org/plugin/the-events-calendar.6.13.1.zip"
