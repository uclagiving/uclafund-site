...
curl -LO "https://downloads.wordpress.org/plugin/all-in-one-wp-security-and-firewall.5.4.2.zip"
...
curl -LO "https://downloads.wordpress.org/plugin/google-analytics-for-wordpress.9.6.1.zip"
curl -LO "https://downloads.wordpress.org/plugin/ilab-media-tools.4.6.4.zip"
curl -LO "https://downloads.wordpress.org/plugin/siteorigin-panels.2.32.1.zip"
curl -LO "https://downloads.wordpress.org/plugin/post-types-order.2.3.7.zip"
...
curl -LO "https://downloads.wordpress.org/plugin/so-widgets-bundle.1.69.1.zip"
curl -LO "https://downloads.wordpress.org/plugin/smart-passworded-pages.zip"
curl -LO "https://downloads.wordpress.org/plugin/the-events-calendar.6.14.1.zip"
curl -LO "https://downloads.wordpress.org/plugin/insert-headers-and-footers.2.2.9.zip"
