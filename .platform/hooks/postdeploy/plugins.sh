...
curl -LO "https://downloads.wordpress.org/plugin/all-in-one-wp-security-and-firewall.5.4.3.zip"
...
curl -LO "https://downloads.wordpress.org/plugin/google-analytics-for-wordpress.9.8.0.zip"
curl -LO "https://downloads.wordpress.org/plugin/ilab-media-tools.4.6.4.zip"
curl -LO "https://downloads.wordpress.org/plugin/siteorigin-panels.2.33.3.zip"
...
curl -LO "https://downloads.wordpress.org/plugin/redux-framework.4.5.8.zip"
curl -LO "https://downloads.wordpress.org/plugin/remove-protected-in-title.zip"
curl -LO "https://downloads.wordpress.org/plugin/so-widgets-bundle.1.69.3.zip"
curl -LO "https://downloads.wordpress.org/plugin/smart-passworded-pages.zip"
curl -LO "https://downloads.wordpress.org/plugin/the-events-calendar.6.15.7.zip"
curl -LO "https://downloads.wordpress.org/plugin/insert-headers-and-footers.2.3.0.zip"
